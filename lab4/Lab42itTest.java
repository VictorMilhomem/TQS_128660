...
public class Lab42itTest {
  ...
  public void lab42it() {
    ...
    driver.findElement(By.id("creditCardNumber")).sendKeys("1234556788");
    driver.findElement(By.id("creditCardMonth")).sendKeys("12");
    driver.findElement(By.id("creditCardMonth")).sendKeys(Keys.DOWN);
    driver.findElement(By.id("creditCardMonth")).sendKeys(Keys.TAB);
    driver.findElement(By.id("creditCardYear")).sendKeys("2020");
    driver.findElement(By.id("nameOnCard")).sendKeys("test name on card");
